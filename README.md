...
- Personalizar fonte, cor, idioma e modo monocromático.
- Salvar e continuar depois — o site lembra das suas informações automaticamente.
- Compartilhar ou imprimir seu currículo quando estiver pronto.

## 🖌️ Personalize do seu jeito
...
- Suas informações ficam salvas no navegador — você pode voltar depois e continuar.
- Para começar mais rápido, use o exemplo e edite com seus dados.
